...
class cnautonews(BaseClass):
    def __init__(self, url_md5 = None, content = None, url = None):
        ...
        self.analyse_rule = {
            'GetTitle': ['#dtitle','.nd_head p','article h1','#art_title','.newstitle','h2','.STYLE11','.article2014_title','.article-title h1','.aticleHead h1','.biaoti'
            ...
            'GetClassify': ['.txt','.map-index h2','.location.font','.det_position','.inf a ','.pos','.dh','.position','.cell_1431_.clearfix','span[style="width:300px; height:20px; float:left; "]','span[style="width:300px; height:20px; float:left;"]',
                            '.breadcrumb','.banci'],
...
if __name__ == '__main__':
    url = "http://www.cnautonews.com/xnyqc/201801/t20180129_570793.htm"
